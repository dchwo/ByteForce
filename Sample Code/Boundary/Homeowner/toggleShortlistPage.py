...
@toggleShortlistPage.route('/shortlist/<int:listing_id>', methods=['POST'])
def toggleShortlist(listing_id):
    ...
    if request.args.get("shortlisted") or (request.referrer and "shortlisted=1" in request.referrer):
