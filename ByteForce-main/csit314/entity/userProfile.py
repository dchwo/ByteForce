...
class UserProfile:
    ...
    def add(self, user_id, role, description):
        """Create a new user profile"""
        sql = "INSERT INTO user_profiles (user_id, role, description) VALUES (%s, %s, %s)"
        self.cursor.execute(sql, (user_id, role, description))
        self.conn.commit()
